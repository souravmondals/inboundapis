namespace ETC.Controllers
{
    ...
    [Route("[controller]")]
    [ApiController]
    public class CreateETCCustomerController : ControllerBase
    {

        private readonly IETCExecution _etcExecution;
        private Stopwatch watch;

        public CreateETCCustomerController(IETCExecution etcExecution)
        {
        ...
        public async Task<IActionResult> Post()
        {
            try
            {
                ...
                _etcExecution.API_Name = "CreateETCCustomer";
                _etcExecution.Input_payload = request.ToString();
                ETCReturn ETCCustomerDetails = await _etcExecution.ValidateETCCustomertInput(request);
